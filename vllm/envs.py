...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # When 1, model structural tags will be used to enforce the model output
    # conforming to the configured tool parser's format and schema.
    # Default 1 (on). Set to 0 to opt out for compatibility testing.
